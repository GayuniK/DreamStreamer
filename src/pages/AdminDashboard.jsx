...
const AdminDashboard = ({ signOut }) => {
  ...
  const handleDeleteAlbum = async (albumId) => {
    ...
    try {
      await axios.delete(`https://0jxojmo6mj.execute-api.ap-south-1.amazonaws.com/Development/albums/${albumId}`);
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const albumArtResponse = await axios.post(
        ...
        'https://0jxojmo6mj.execute-api.ap-south-1.amazonaws.com/Development/generating-s3-links',
        {
      ...
      await axios.post('https://0jxojmo6mj.execute-api.ap-south-1.amazonaws.com/Development/albums', albumMetadata);
  ...
  const handleUpdateAlbum = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://0jxojmo6mj.execute-api.ap-south-1.amazonaws.com/Development/albums/${selectedAlbum.albumId}`,
        updatedAlbum
      );
  ...
  const requestAnalyticsReport = async () => {
    try {
        const response = await axios.post('https://0jxojmo6mj.execute-api.ap-south-1.amazonaws.com/Development/send-inventory-reports');
  ...
  return (
    <div className="w-full h-screen bg-slate-950 text-white flex flex-col">
      {/* Header */}
      <header className="flex justify-between p-4 bg-black w-full">
        <h1 className="text-2xl font-bold">Admin Dashboard</h1>
        <button
          onClick={signOut}
          className="py-2 px-4 bg-blue-500 text-white rounded hover:bg-red-600 transition duration-200"
        >
          Sign Out
        </button>
      </header>
      ...
      <button onClick={requestAnalyticsReport} className="py-2 px-4 bg-sky-900 rounded hover:bg-sky-950">
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button
            ...
            className="py-2 px-4 bg-teal-500 rounded hover:bg-teal-700 transition duration-200"
          >
      ...
      {selectedAlbum && (
          <div className="mt-0 bg-gray-800 p-8 bg-slate-950">
      ...
      <div className="p-6 flex-grow bg-slate-950">
          ...
          {filterAlbums().map((album) => (
            <div key={album.albumId} onClick={() => handleAlbumClick(album)} className="cursor-pointer">
              <img
                ...
                alt={album.albumName}
                className="w-full h-60 object-cover rounded-lg mb-2 hover:opacity-80 transition duration-200"
              />
